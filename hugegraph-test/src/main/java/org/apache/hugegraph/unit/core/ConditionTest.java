...
public class ConditionTest extends BaseUnitTest {
    ...
    public void testConditionIn() {
        ...
        Assert.assertThrows(IllegalArgumentException.class, () -> {
            Condition c2 = new Condition.SyspropRelation(HugeKeys.ID,
    ...
    public void testConditionNotIn() {
        ...
        Assert.assertThrows(IllegalArgumentException.class, () -> {
            Condition c2 = new Condition.SyspropRelation(HugeKeys.ID, Condition.RelationType.NOT_IN,
                                                         "single-value");
            c2.test("singlevalue");
        }, e -> {
    ...
    public void testConditionPrefix() {
        ...
        Assert.assertThrows(IllegalArgumentException.class, () -> {
            Condition c2 = new Condition.SyspropRelation(HugeKeys.ID, Condition.RelationType.PREFIX,
                                                         "abc");
    ...
    public void testConditionTextContainsAny() {
        ...
        Assert.assertThrows(IllegalArgumentException.class, () -> {
            Condition c2 = new Condition.SyspropRelation(HugeKeys.ID,
                                                         Condition.RelationType.TEXT_CONTAINS_ANY,
                                                         "abc");
            c2.test("abc");
        }, e -> {
