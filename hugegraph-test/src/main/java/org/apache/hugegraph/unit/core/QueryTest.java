...
public class QueryTest {
    ...
    public void testOrderBy() {
        ...
        Assert.assertEquals(ImmutableMap.of(HugeKeys.NAME, Query.Order.ASC),
                            query.orders());
    }
    ...
    public void testToString() {
        ...
        query = new Query(HugeType.VERTEX);
        query.aggregate(Aggregate.AggregateFunc.MAX, "age");
        query.limit(10L);
        ...
        query.limit(10L);
        query.order(HugeKeys.NAME, Query.Order.ASC);
        query.order(HugeKeys.FIELDS, Query.Order.DESC);
