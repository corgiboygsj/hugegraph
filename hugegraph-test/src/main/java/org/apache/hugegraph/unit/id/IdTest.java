...
public class IdTest extends BaseUnitTest {
    ...
    public void testLongId() {
        ...
        Assert.assertEquals(id, IdGenerator.ofStoredString("1w", Id.IdType.LONG));
    }
    ...
    public void testUuidId() {
        ...
        Assert.assertEquals(id, IdGenerator.ofStoredString(
                "g14RU5KBSVeGkc95JY6Q6w==", Id.IdType.UUID));
    }
    ...
    public void testObjectId() {
        ...
        Assert.assertEquals(Id.IdType.UNKNOWN, id.type());
    ...
    public void testOfObjectId() {
        ...
        Assert.assertEquals(Id.IdType.LONG, id1.type());
        ...
        Assert.assertEquals(Id.IdType.STRING, id3.type());
        ...
        Assert.assertEquals(Id.IdType.UUID, id5.type());
        ...
        Assert.assertEquals(Id.IdType.UNKNOWN, id7.type());
    ...
    public void testIdType() {
        ...
        Assert.assertEquals('L', Id.IdType.LONG.prefix());
        Assert.assertEquals('U', Id.IdType.UUID.prefix());
        Assert.assertEquals('S', Id.IdType.STRING.prefix());
        Assert.assertEquals('E', Id.IdType.EDGE.prefix());
        Assert.assertEquals('N', Id.IdType.UNKNOWN.prefix());
    }
}
