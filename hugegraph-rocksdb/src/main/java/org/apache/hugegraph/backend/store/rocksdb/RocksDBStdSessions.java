...
public class RocksDBStdSessions extends RocksDBSessions {
    ...
    private final class StdSession extends RocksDBSessions.Session {
         ...
         */
        @Override
        public BackendEntry.BackendColumnIterator scan(String table, byte[] keyFrom,
     ...
     */
    private static class ColumnIterator implements
                                        BackendEntry.BackendColumnIterator,
                                        Countable {
        ...
        public BackendEntry.BackendColumn next() {
            ...
            BackendEntry.BackendColumn
                    col = BackendEntry.BackendColumn.of(this.iter.key(),
                                                        this.iter.value());
            this.iter.next();
            this.matched = false;
