...
public class StandardHugeGraph implements HugeGraph {
    ...
    public void registerRpcServices(RpcServiceConfig4Server serverConfig,
        ...
        Class<CacheNotifier.GraphCacheNotifier> clazz1 = CacheNotifier.GraphCacheNotifier.class;
        ...
        Class<CacheNotifier.SchemaCacheNotifier> clazz2 = CacheNotifier.SchemaCacheNotifier.class;
    ...
    private static class HugeSchemaCacheNotifier
            ...
            implements CacheNotifier.SchemaCacheNotifier {
    ...
    private static class HugeGraphCacheNotifier
                   extends AbstractCacheNotifier
            implements CacheNotifier.GraphCacheNotifier {
