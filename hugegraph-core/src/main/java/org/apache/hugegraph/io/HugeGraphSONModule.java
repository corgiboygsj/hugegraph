...
public class HugeGraphSONModule extends TinkerPopJacksonModule {
    ...
    public static void registerIdSerializers(SimpleModule module) {
        ...
        module.addDeserializer(IdGenerator.StringId.class,
        ...
        module.addDeserializer(IdGenerator.LongId.class,
        ...
        module.addDeserializer(IdGenerator.UuidId.class,
                               new IdDeserializer<>(IdGenerator.UuidId.class));
