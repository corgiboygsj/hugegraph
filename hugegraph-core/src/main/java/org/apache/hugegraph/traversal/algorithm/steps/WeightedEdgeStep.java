...
public class WeightedEdgeStep {
    ...
    public WeightedEdgeStep(HugeGraph g, Directions direction, List<String> labels,
        ...
        this(g, direction, labels, properties,
             Long.parseLong(HugeTraverser.DEFAULT_MAX_DEGREE), 0L, null, 0.0D,
             Long.parseLong(HugeTraverser.DEFAULT_SAMPLE));
    }
    ...
    public WeightedEdgeStep(HugeGraph g, Directions direction, List<String> labels,
        ...
        E.checkArgument(sample > 0L || sample == HugeTraverser.NO_LIMIT,
                        "The sample must be > 0 or == -1, but got: %s",
                        sample);
        E.checkArgument(maxDegree == HugeTraverser.NO_LIMIT || maxDegree >= sample,
