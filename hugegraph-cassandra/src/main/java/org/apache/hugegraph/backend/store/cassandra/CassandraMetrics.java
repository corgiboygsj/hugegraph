...
public class CassandraMetrics implements BackendMetrics {
    ...
    public CassandraMetrics(HugeConfig conf,
        ...
        String v = BackendTable.joinTableName(g, CassandraTables.Vertex.TABLE);
        String oe = BackendTable.joinTableName(g, "o" + CassandraTables.Edge.TABLE_SUFFIX);
        String ie = BackendTable.joinTableName(g, "i" + CassandraTables.Edge.TABLE_SUFFIX);
