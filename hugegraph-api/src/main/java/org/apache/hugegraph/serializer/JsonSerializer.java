...
public class JsonSerializer implements Serializer {
    ...
    @Override
    public String writeSimilars(FusiformSimilarityTraverser.SimilarsMap similars,
                                Iterator<Vertex> vertices) {
    ...
    @Override
    public String writeWeightedPath(
            SingleSourceShortestPathTraverser.NodeWithWeight path,
            Iterator<Vertex> vertices) {
    ...
    @Override
    public String writeWeightedPaths(
