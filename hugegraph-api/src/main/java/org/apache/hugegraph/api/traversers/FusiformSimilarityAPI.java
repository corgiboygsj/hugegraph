...
public class FusiformSimilarityAPI extends API {
    ...
    public String post(@Context GraphManager manager,
        ...
        FusiformSimilarityTraverser.SimilarsMap result = traverser.fusiformSimilarity(
    ...
    private static class FusiformSimilarityRequest {
        ...
        public long maxDegree = Long.parseLong(HugeTraverser.DEFAULT_MAX_DEGREE);
        @JsonProperty("capacity")
        public long capacity = Long.parseLong(HugeTraverser.DEFAULT_CAPACITY);
        @JsonProperty("limit")
        public long limit = Long.parseLong(HugeTraverser.DEFAULT_PATHS_LIMIT);
